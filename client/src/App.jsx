...
import CCDivision from "./Components/Faculty/CCDivision";
    ...
    return (
      <>
        <Routes>
          ...
          <Route
            exact
            path="/faculty/facultyassignments"
            element={
              User && User.user_type == "teacher" ? (
                <AssignmentPosted />
              ) : (
          ...
          <Route
            path="/student/labs"
            element={
              User && User.user_type == "student" ? <Lab /> : <StudentLogin />
            }
          />
          <Route
