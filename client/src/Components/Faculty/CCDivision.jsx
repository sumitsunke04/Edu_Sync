...
import FinalApprovalTable from "./../ReusableComponents/FinalApprovalTable";
...
const CCDivision = () => {
  ...
  useEffect(() => {
    ...
    const fetchData = async () => {
      try {
        const data2 = await FetchCCDivisionData();
        console.log(data2);
        if (data2) {
  ...
  //         (division) => division._id === divisionID.divID
  //       );
  //       return {
